...
const token =
  "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";
...
function getRepo(resp) {
  ...
  const query = `{
    viewer {
      ...
      bio
      avatarUrl(size: 260)
      repositories(last: 15, orderBy: {field: UPDATED_AT, direction: DESC}) {
        nodes {
          name
          updatedAt
          stargazerCount
...
// const GITHUB_TOKEN = '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';
...
//     method: 'POST',
//     headers: {
//       'Authorization': `Bearer ${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}`,
